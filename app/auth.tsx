          ...
          {step === "email" ? (
            <>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.85}
                className={`mt-4 rounded py-4 items-center justify-center ${email.trim() ? "bg-primary" : "bg-muted-foreground"}`}
              >
                <Text>Send OTP</Text>
              </TouchableOpacity>
            </>
            ...
            <>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.85}
                className={`mt-4 rounded py-4 items-center justify-center ${otp.length >= 6 ? "bg-primary" : "bg-muted-foreground"}`}
              >
