...
const WalletIconSvg = ({ color, width, height, size, style, ...props }: SvgProps & { size?: number, style?: { color?: string; width?: number; height?: number } }) => (
